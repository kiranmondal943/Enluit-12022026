...
# --- 1. APP CONFIGURATION ---
st.set_page_config(
    page_title="Titan v32.0 | Mobile Optimized", 
    layout="wide", 
    page_icon="⚡",
...
with st.sidebar:
    ...
    st.caption("v32.0 | Mobile & Social Fixes")
    st.divider()
...
def get_theme_css():
    ...
    * {{ box-sizing: border-box; }}
    ...
    {hero_css}
    .hero p {{ color: rgba(255,255,255,0.9); font-size: clamp(1.1rem, 2vw, 1.3rem); max-width: 700px; margin: 0 auto 2rem auto; }}
